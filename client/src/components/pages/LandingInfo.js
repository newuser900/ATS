			...
			<div className="landingInfo">
				<Row className="my-5 text-image-row">
					<Col>
						<Image
							fluid
							src="https://sastrysonline.com/img/online-coaching.png"
							alt="proctured exam"
							className="landingPage-img"
						/>
					</Col>
					<Col className="m-auto">
						<h3 className="text-success">Online Student Attention Tracking System</h3>
						<span>
							Online procturing to track student activities and attentiveness in Online education
							environments like Online Examinations, online lectures and virtual classrooms.
						</span>
					</Col>
				</Row>
				<Row className="my-5 text-image-row">
					...
					<Col className="m-auto">
						...
						<span>
							The software makes it possible to take exams from anywhere. You just need a webcam and an
							internet connection. The integrated attention tracking AI prevents dishonest behavior
							ensuring fairness.
						</span>
					</Col>
				</Row>
				<Row className="my-5 text-image-row">
					<Col className="w-auto">
						<Image
							fluid
							src="https://www.flaticon.com/svg/static/icons/svg/921/921591.svg"
							alt="analytics"
							className="landingPage-img"
						/>
					</Col>
					<Col className="m-auto">
						<h3 className="text-success">
							Insightful analytics and visualization of Student's attention logs
						</h3>
						<span>
							The application monitors and logs student attentiveness and other activities and generates
							visualizations which can help teachers assess students
						</span>
					</Col>
				</Row>
			</div>
			...
			<div className="features-container">
				...
				<div className="feature">
					<Image
						...
						className="feature-img"
					/>
					<small className="feature-text">automated procturing and evaluation</small>
				</div>
				<div className="feature">
					<Image
						fluid
